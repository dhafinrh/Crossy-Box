...
public class Eagle : MonoBehaviour
{
    ...
    public void EagleMove(Vector3 bisonPosition)
    {
        ...
        Vector3 currentPosition = bisonPosition + new Vector3(0, 2, 0);
        Sequence sequence = DOTween.Sequence();
        sequence.Append(transform.DOMove(currentPosition, 2f).SetEase(Ease.OutQuart));
        sequence.Append(transform.DOLocalMove(currentPosition + new Vector3(0, 10, 15), 3f).SetEase(Ease.InQuart));
